...
Este directorio contiene la documentación técnica detallada y los archivos de código fuente correspondientes a la pestaña de **Servicios** (el "ServiciosScreen" virtual) de la aplicación **cinemark-app** (proyecto `proyeccion-app`).
...
1. **[1. Programaciones (`ProgramacionTab.tsx`)](./1_programaciones.md)**:
...
2. **[2. Marketing (`MarketingTab.tsx`)](./2_marketing.md)**:
...
3. **[3. Control de Salas (`ControlSalasScreen.tsx`)](./3_control_salas.md)**:
...
- **[ProgramacionTab.tsx](./code/screens/ProgramacionTab.tsx)**: Interfaz de carga de reportes, días de programación y configuración de pisos.
- **[MarketingTab.tsx](./code/screens/MarketingTab.tsx)**: Interfaz de comparación de cartelera semanal y exportación a PDF.
- **[ControlSalasScreen.tsx](./code/screens/ControlSalasScreen.tsx)**: Interfaz gráfica de planos de butacas, inspección y editor de mapas.

### Librerías Auxiliares y Lógica de Negocio (`code/lib/`)
- **[cineConfig.ts](./code/lib/cineConfig.ts)**: Recuperación de cantidad de salas por cine.
- **[theme.ts](./code/lib/theme.ts)**: Paleta de colores e identificadores de estilos UI.
- **[useAuthUser.ts](./code/lib/useAuthUser.ts)**: Hook de autenticación de usuario (cineId, email, etc.).
- **Carpeta [marketing/](./code/lib/marketing)**:
...
- **Carpeta [programacion/](./code/lib/programacion)**:
...
>
> El archivo complementario **[firebaseConfig.ts](./code/lib/firebaseConfig.ts)** únicamente inicializa el SDK de Firebase (Auth y Firestore) que sirve como respaldo secundario y almacena nombres de constantes globales.
